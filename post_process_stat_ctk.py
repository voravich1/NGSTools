...
p = Path("C:/Users/vorav/Desktop/opas_bgi_set2/test_post_ctk")

useable_read_pool_inf = p / "pool_virus_inf_r2_pool.bed"
useable_read_pool_non = p / "pool_virus_non_r2_pool.bed"
useable_read_sm_inf = p / "sm_virus_inf_r2_pool.bed"
useable_read_sm_non = p / "sm_virus_non_r2_pool.bed"

pool_inf_peak_bed = p / "pool_virus_inf_r2_pool_peak_sig.bed"
pool_non_peak_bed = p / "pool_virus_non_r2_pool_peak_sig.bed"
...
pool_inf_bedgraph = p / "pool_virus_inf_r2_pool.bedgraph"
pool_non_bedgraph = p / "pool_virus_non_r2_pool.bedgraph"
sm_inf_bedgraph = p / "sm_virus_inf_r2_pool.bedgraph"
sm_non_bedgraph = p / "sm_virus_non_r2_pool.bedgraph"
